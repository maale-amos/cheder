...
// ה-cache משמש רק כגיבוי כשאין רשת. (cache-first גרם לכך שמשתמשים ראו גרסה ישנה לנצח.)
const CACHE = 'cv3-v3';
const ASSETS = ['./', 'index.html', 'css/main.css', 'manifest.webmanifest', 'favicon.svg', 'icon-192.png',
  'js/config.js', 'js/supabase.js', 'js/api.js', 'js/store.js', 'js/ui.js', 'js/auth.js', 'js/picker.js',
  'js/students.js', 'js/behavior.js', 'js/tracking.js', 'js/dashboard.js', 'js/admin.js',
  'js/cashbox.js', 'js/forms.js', 'js/teacher.js', 'js/app.js'];
